library(tidyverse)
load("./full_shape_classification_SRVF/results/results_rf_species_given_tribe.rda")
load("./full_shape_classification_SRVF/results/results_svm_radial_species_given_tribe.rda")
load("./full_shape_classification_SRVF/results/results_svm_linear_species_given_tribe.rda")
...
png("./full_shape_classification_SRVF/figures/species_given_tribe_accuracy.png", res = 300, units = "in", h = 5, w = 8)
library(ggplot2)
...
load("./full_shape_classification_SRVF/results/results_rf_tribe.rda")
load("./full_shape_classification_SRVF/results/results_svm_radial_tribe.rda")
load("./full_shape_classification_SRVF/results/results_svm_linear_tribe.rda")
...
png("./full_shape_classification_SRVF/figures/tribe_accuracy.png", res = 300, units = "in", h = 5, w = 8)
library(ggplot2)
ggplot(aes(x = proj, y = accuracy, colour = method, group = method), data = res) + geom_point(aes(group = method)) + facet_grid(toothnum~toothchar) + 
  geom_line(aes(group = method))+ xlab("Feature Generation Method") + ylab("Accuracy")
dev.off()
...
png("./full_shape_classification_SRVF/figures/tribe_accuracy_by_tribe.png", res = 300, units = "in", h = 5, w = 8)
