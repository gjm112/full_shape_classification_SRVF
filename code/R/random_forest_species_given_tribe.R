...
if (!size){
  save(results_rf_tribe, 
     file = "./full_shape_classification_SRVF/results/results_rf_tribe.rda")

save(results_rf_species, 
     file = "./full_shape_classification_SRVF/results/results_rf_species.rda")

save(results_rf_species_given_tribe, 
file = "./full_shape_classification_SRVF/results/results_rf_species_given_tribe.rda")
}

if (size){
  save(results_rf_tribe, 
       file = "./full_shape_classification_SRVF/results/results_rf_tribe_with_size.rda")
  
  save(results_rf_species, 
       file = "./full_shape_classification_SRVF/results/results_rf_species_with_size.rda")
  
  save(results_rf_species_given_tribe, 
       file = "./full_shape_classification_SRVF/results/results_rf_species_given_tribe_with_size.rda")
}
