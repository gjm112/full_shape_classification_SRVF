...
save(results_svm_radial_tribe, 
     file = "/full_shape_classification_SRVF/results/results_svm_radial_tribe.rda")

save(results_svm_radial_species, 
     file = "/full_shape_classification_SRVF/results/results_svm_radial_species.rda")

save(results_svm_radial_species_given_tribe, 
     file = "/full_shape_classification_SRVF/results/results_svm_radial_species_given_tribe.rda")
}

if (size){
  save(results_svm_radial_tribe, 
       file = "/full_shape_classification_SRVF/results/results_svm_radial_tribe_with_size.rda")
  
  save(results_svm_radial_species, 
       file = "/full_shape_classification_SRVF/results/results_svm_radial_species_with_size.rda")
  
  save(results_svm_radial_species_given_tribe, 
       file = "/full_shape_classification_SRVF/results/results_svm_radial_species_given_tribe_with_size.rda")
}
